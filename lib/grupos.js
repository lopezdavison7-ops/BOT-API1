...
export function esParticipanteAdmin(metadata, jid) {
    ...
    // Se revisan TODOS los identificadores de cada participante
    // (id, jid, phoneNumber, lid) — no solo `id`, que puede venir
    // como @lid y nunca coincidir con el número real del mensaje.
