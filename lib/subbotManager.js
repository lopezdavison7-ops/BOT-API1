...
// ============================================================
// TOKEN DEL PANEL (seguridad: solo el dispositivo que vinculó
// el subbot puede administrar sus owners o eliminarlo)
// ============================================================
...
function asegurarToken(authFolder, id) {
    ...
    try {
        ...
        console.log(`[SUBBOT ${id}] 🔑 Token de panel migrado.`);
    } catch (error) {
...
export function crearSubbot(numeroCrudo) {
    return new Promise((resolve, reject) => {
        ...
        // Token del panel: solo este dispositivo podrá administrar el subbot
        const token = generarToken();
        try {
            fs.writeFileSync(
...
// ============================================================
// RECONECTAR SUBBOTS YA VINCULADOS
// ============================================================
