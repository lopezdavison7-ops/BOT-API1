...
//
// 🔇 PRIMARY POR GRUPO: si un grupo tiene un primary definido
// (database/subbotPrimary.json), los demás subbots se quedan
// en silencio SOLO en ese grupo. En privados y otros grupos
// todo sigue normal.
// ============================================================
...
async function conectarSubbot({ id, authFolder, numero, esNuevo, resolverCodigo, rechazarCodigo }) {
    try {
        ...
        sock.ev.on('messages.upsert', async ({ messages }) => {
            ...
            // 🔇 PRIMARY POR GRUPO: si este grupo tiene un primary
            // definido y este subbot no lo es, se queda en silencio
            // SOLO en este grupo (privados y otros grupos: normal).
