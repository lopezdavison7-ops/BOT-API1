...
//
// 🔇 SISTEMA PRIMARY: si hay un subbot marcado como principal
// (database/subbotPrimary.json), los demás subbots dejan de
// responder automáticamente (solo dejan pasar .setprimary).
// ============================================================
...
import { subbotPuedeResponder } from './subbotPrimary.js';
...
async function conectarSubbot({ id, authFolder, numero, esNuevo, resolverCodigo, rechazarCodigo }) {
    try {
        ...
        sock.ev.on('messages.upsert', async ({ messages }) => {
            ...
            // 🔇 SISTEMA PRIMARY: si hay un subbot marcado como
            // principal, este subbot NO responde (silencioso).
            // La única excepción es .setprimary, para poder
            // transferir o quitar el primary desde cualquier subbot.
            if (!subbotPuedeResponder(sock, m)) return;
